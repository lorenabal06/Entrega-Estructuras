...
class TestIteradorListaDoblementeEnlazada {
    ...
    @Test
    void testHasNext() {
        assertTrue(iterador.hasNext()); // Al inicio hay elementos
        iterador.next();
        iterador.next();
        iterador.next();
    ...
    void testHasPrevious() {
        iterador.next();
        assertTrue(iterador.hasPrevious()); // Ahora debería haber un anterior
        iterador.previous();
        assertFalse(iterador.hasPrevious()); // Al inicio no hay anterior
    }
